...
export const mobileParityInventory = [
  ...
  {
    assertions: ['TenTap native simulator rendering', 'document-content hydration and serialization with raw frontmatter, desktop highlight, wikilink alias/no-alias, display math, hard-break, unsupported-table, details block, root image, and indented image-source regression checks'],
