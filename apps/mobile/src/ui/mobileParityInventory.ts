...
export const mobileParityInventory = [
  ...
  {
    assertions: ['WYSIWYG wikilink, person mention, and emoji picker suggestion tests', 'native iOS WYSIWYG wikilink, person mention, and emoji insertion proof'],
    contracts: ['desktopEditorParity', 'desktopToolbarActionParity'],
  ...
  {
    assertions: ['single document source edit user-flow checks', 'source YAML warning and incomplete-frontmatter metadata preservation checks', 'native source selection plus wikilink, person, and emoji autocomplete preservation proof', 'wikilink, person, and emoji autocomplete user-flow checks'],
    contracts: ['desktopEditorParity', 'desktopToolbarActionParity'],
