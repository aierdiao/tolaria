...
- Phone navigation now uses the same reducer-backed workspace controller as tablet for list, sidebar, editor, properties, action sheets, wikilinks, relationships, saved views, folders, and persistence writes. Native navigation animations and deeper phone-specific polish remain after the tablet/mobile editing contract is stable.
